...
import com.dou361.jjdxm_simijkplayer.listener.OnControlPanelVisibilityChangeListener;
import com.dou361.jjdxm_simijkplayer.listener.OnInfoListener;
...
public class LivePlayerView {
     ...
     * 禁止触摸
     */
    private boolean forbidTouch = true;
    /**
     * 是否可以拖动进度条
     */
     ...
     * 播放几种状态监听监听
     */
    public LivePlayerView onInfo(OnInfoListener onInfoListener) {
        this.onInfoListener = onInfoListener;
        return this;
    }

    public LivePlayerView onControlPanelVisibilityChang(OnControlPanelVisibilityChangeListener listener) {
    ...
    private final View.OnClickListener onClickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            if (v.getId() == ResourceUtils.getResourceIdByName(mContext, "id", "app_video_netTie_icon")) {
                isGNetWork = false;
                doPauseResume();
