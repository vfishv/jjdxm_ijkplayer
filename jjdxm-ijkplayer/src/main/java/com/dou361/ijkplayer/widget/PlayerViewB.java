 ...
 * ========================================
 */
public class PlayerViewB extends FrameLayout {

    /**
     * 打印日志的TAG
     */
    private static final String TAG = PlayerViewB.class.getSimpleName();
    /**
     * 全局上下文
     */
     ...
     * 声音面板
     */
    private View volumeControllerContainer;
    /**
     * 亮度面板
     */
     ...
     * 亮度进度条滑动监听
     */
    private SeekBar.OnSeekBarChangeListener onBrightnessControllerChangeListener = new SeekBar.OnSeekBarChangeListener() {
        /**数值的改变*/
        public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
     ...
     * 声音进度条滑动监听
     */
    private SeekBar.OnSeekBarChangeListener onVolumeControllerChangeListener = new SeekBar.OnSeekBarChangeListener() {
    ...
    public PlayerViewB(Context context) {
        this(context, (AttributeSet) null, 0);
    }

    public PlayerViewB(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public PlayerViewB(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void init(Context context) {
        ...
        rootView = inflater.inflate(ResourceUtils.getResourceIdByName(mContext, "layout", "simple_player_view_player"), (ViewGroup) null);
     ...
     * 设置播放区域拉伸类型
     */
    public PlayerViewB init(Activity activity) {
        mActivity = activity;
     ...
     * }
     */
//    public PlayerViewB onConfigurationChanged(Configuration newConfig) {
...
//    }
     ...
     * 显示缩略图
     */
    public PlayerViewB showThumbnail(OnShowThumbnailListener onShowThumbnailListener) {
     ...
     * 设置播放信息监听回调
     */
    public PlayerViewB setOnInfoListener(IMediaPlayer.OnInfoListener onInfoListener) {
     ...
     * 设置播放器中的返回键监听
     */
    public PlayerViewB setPlayerBackListener(OnPlayerBackListener listener) {
     ...
     * 设置控制面板显示隐藏监听
     */
    public PlayerViewB setOnControlPanelVisibilityChangListenter(OnControlPanelVisibilityChangeListener listener) {
     ...
     * 百分比显示切换
     */
    public PlayerViewB toggleAspectRatio() {
        if (videoView != null) {
     ...
     * 设置播放区域拉伸类型
     */
    public PlayerViewB setScaleType(int showType) {
     ...
     * 旋转角度
     */
    public PlayerViewB setPlayerRotation() {
        if (rotation == 0) {
            rotation = 90;
        } else if (rotation == 90) {
            rotation = 270;
     ...
     * 旋转指定角度
     */
    public PlayerViewB setPlayerRotation(int rotation) {
        if (videoView != null) {
     ...
     * 对应地址列表
     */
    public PlayerViewB setPlaySource(List<VideoijkBean> list) {
        listVideos.clear();
     ...
     * 单个视频VideoijkBean
     */
    public PlayerViewB setPlaySource(VideoijkBean videoijkBean) {
        listVideos.clear();
     ...
     * 带流名称
     */
    public PlayerViewB setPlaySource(String stream, String url) {
     ...
     * 单个视频地址时
     */
    public PlayerViewB setPlaySource(String url) {
     ...
     * 自动播放
     */
    public PlayerViewB autoPlay(String path) {
        setPlaySource(path);
        startPlay();
        return this;
    }
     ...
     * 设置视频名称
     */
    public PlayerViewB setTitle(String title) {
     ...
     * 选择要播放的流
     */
    public PlayerViewB switchStream(int index) {
     ...
     * 设置播放位置
     */
    public PlayerViewB seekTo(int playtime) {
     ...
     *                   false 不进行网络类型提示
     */
    public PlayerViewB setNetWorkTypeTie(boolean isGNetWork) {
     ...
     */
    public PlayerViewB setChargeTie(boolean isCharge, int maxPlaytime) {
        return this;
    }
     ...
     * 是否仅仅为全屏
     */
    public PlayerViewB setOnlyFullScreen(boolean isFull) {
     ...
     * 设置是否禁止双击
     */
    public PlayerViewB setForbidDoulbeUp(boolean flag) {
     ...
     * 设置是否禁止隐藏bar
     */
    public PlayerViewB setForbidHideControlPanl(boolean flag) {
     ...
     * 是否禁止触摸
     */
    public PlayerViewB forbidTouch(boolean forbidTouch) {
     ...
     */
    public PlayerViewB hideBack(boolean isHide) {
     ...
     */
    public PlayerViewB hideMenu(boolean isHide) {
     ...
     */
    public PlayerViewB hideSteam(boolean isHide) {
     ...
     */
    public PlayerViewB hideRotation(boolean isHide) {
     ...
     */
    public PlayerViewB hideFullscreen(boolean isHide) {
     ...
     */
    public PlayerViewB hideCenterPlayer(boolean isHide) {
     ...
     */
    public PlayerViewB hideHideTopBar(boolean isHide) {
        isHideTopBar = isHide;
     ...
     */
    public PlayerViewB hideBottonBar(boolean isHide) {
     ...
     */
    public PlayerViewB hideControlPanl(boolean isHide) {
     ...
     */
    public PlayerViewB setAutoReConnect(boolean isAuto, int connectTime) {
     ...
     * 显示或隐藏操作面板
     */
    public PlayerViewB operatorPanl() {
     ...
     * 全屏切换
     */
    public PlayerViewB toggleFullScreen() {
     ...
     * 进度条和时长显示的方向切换
     */
    public PlayerViewB toggleProcessDurationOrientation() {
     ...
     * 设置显示加载网速或者隐藏
     */
    public PlayerViewB setShowSpeed(boolean isShow) {
     ...
     */
    public PlayerViewB setProcessDurationOrientation(int portrait) {
